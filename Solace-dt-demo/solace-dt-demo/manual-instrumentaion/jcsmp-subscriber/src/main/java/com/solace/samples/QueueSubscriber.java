...
public class QueueSubscriber {
    ...
    private static final String SAMPLE_NAME = QueueSubscriber.class.getSimpleName();
    private static final String SERVICE_NAME = "SolaceJCSMPQueueSubscriberManualInstrumentation";
